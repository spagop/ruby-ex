...
<head>
  ...
  <title>Welcome to OpenShift Admiralbogen hfhfhsfhfsh</title>
...
<section class='container'>
          <hgroup>
            <h1>Welcome to your Ruby application on OpenShift fhdfhdfgdfgdfgdfgdfgdf</h1>
          </hgroup>
...
<p>After pushing changes, you'll need to manually trigger a build if you did not setup a webhook as described above.</p>
          ...
          <section class="col-xs-12 col-sm-6 col-md-6">
                ...
                <h2>Managing My Second / Night Ruby application</h2>
